"function" != typeof Object.create && (Object.create = function (t) {
    ...
    var n = {
        ...
        setup: function () {
            ...
            if (this._toastEl = this._toastEl || t("<div></div>", {
            ...
            }), o += '<span class="jq-toast-loader"></span><svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="float: left;margin-right: 10px;color:rgb(255, 255, 255);padding:2px;background-color:rgb(48, 166, 109);border-radius:9999px;flex-shrink:0;width: 1.25rem;height:20px;display:block;vertical-align:middle;box-sizing:border-box;border-width:0px;border-style:solid;border-color:rgb(237, 237, 237);" class="js-toast-true-icon">\n' +
                '                            <polyline points="20 6 9 17 4 12" style="box-sizing:border-box;border-width:0px;border-style:solid;border-color:rgb(237, 237, 237);"></polyline>\n' +
                '                        </svg><svg stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style="float: left;margin-right: 10px;color:rgb(255, 255, 255);padding:2px;background-color:rgb(204, 41, 41);border-radius:9999px;flex-shrink:0;width: 1.25rem;height:20px;display:block;vertical-align:middle;box-sizing:border-box;border-width:0px;border-style:solid;border-color:rgb(237, 237, 237);" class="js-toast-error-icon">\n' +
                '                            <line x1="18" x2="6" y1="6" y2="18" style="box-sizing:border-box;border-width:0px;border-style:solid;border-color:rgb(237, 237, 237);"></line>\n' +
                '                            <line x1="6" x2="18" y1="6" y2="18" style="box-sizing:border-box;border-width:0px;border-style:solid;border-color:rgb(237, 237, 237);"></line>\n' +
                '                        </svg>', this.options.allowToastClose && (o += '<span class="close-jq-toast-single">&times;</span>'), this.options.text instanceof Array) {
                ...
                this.options.heading && (o += '<h2 class="jq-toast-heading">' + this.options.heading + "</h2>"), o += "<div class='js-text'>"+this.options.text+"</div>";
